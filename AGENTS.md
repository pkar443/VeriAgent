...
4. Only use `search_confluence` and `get_confluence_page` when you need to inspect sources manually or when the retrieval-first tools do not provide enough detail.
